    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Add Customer Bill</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" id="c_name" required>
                      ...
                      <?php
                      $query = mysqli_query($conn, "SELECT * FROM add_account WHERE account_type='customer'");
              ...
              <div class="row">
                ...
                <div class='col-md-9' id='variant_col'>
              ...
              <div class='row'>
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter Quantity" value="1" id="quantity">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
      ...
      <div class='row'>
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Customer Bill Details</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <div class="card-body">
...
<input type="hidden" value='customer' id='bill_type'>
...
<script>
  $(document).ready(function () {
    ...
    $("#add").click(function () {
      ...
      html += "<td>" + p_price + "</td>";
      html += "<td>" + total + "</td>";
      html += "<td><button id='" + sno + "' class='btn btn-danger del_btn' value='" + total + "'>X</button></td>";
      html += "</tr>";
      $("#area").append(html);
