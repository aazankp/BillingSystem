  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Customer Bill</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Add Customer Bill</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="form-control" id='account' name="account" required>
                      ...
                      <?php                      
                      $fetch=mysqli_query($conn,"SELECT * FROM add_account WHERE account_type='customer'");
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" id="tot_amount" placeholder="Total Amount" name="tot_amount">
                  </div>
                  </div>
                  <!-- /.row -->
