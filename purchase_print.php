...
if ($from_date = $_GET['from_date'] & $to_date = $_GET['to_date']) {
  $posquery=mysqli_query($conn,"SELECT * FROM bill WHERE bill_type='purchaser' AND date>='$from_date' AND date<='$to_date'");
  $accountquery=mysqli_query($conn,"SELECT * FROM account_bill WHERE bill_type='purchaser' AND date>='$from_date' AND date<='$to_date'");
}else{
  $from_date="";
  $to_date="";
  $posquery=mysqli_query($conn,"SELECT * FROM bill WHERE bill_type='purchaser'");
  $accountquery=mysqli_query($conn,"SELECT * FROM account_bill WHERE bill_type='purchaser'");
}
?>
<!DOCTYPE html>
<html lang="en">
