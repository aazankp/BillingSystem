        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                ...
                <a href="customer_bill.php" class="btn btn-info float-right">Add Customer Bill</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<?php
    ...
    $query=mysqli_query($conn,"SELECT * FROM account_bill WHERE bill_type='sell'");
