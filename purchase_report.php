...
if (isset($_POST['go'])) {
  ...
  $purch_posquery=mysqli_query($conn,"SELECT * FROM bill WHERE bill_type='purchaser' AND date>='$from_date' AND date<='$to_date'");
  $purch_accountquery=mysqli_query($conn,"SELECT * FROM account_bill WHERE bill_type='purchaser' AND date>='$from_date' AND date<='$to_date'");
}else{
  $from_date="";
  $to_date="";
  $purch_posquery=mysqli_query($conn,"SELECT * FROM bill WHERE bill_type='purchaser'");
  $purch_accountquery=mysqli_query($conn,"SELECT * FROM account_bill WHERE bill_type='purchaser'");
}
?>  
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0">Purchaser Details</h3>
...
<div class="row">
<div class="col-12">
<h4>Purchases <small>Report</small></h4>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">POS Purchases</a>
</li>
<li class="nav-item">
<a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Account Purchases</a>
</li>
</ul>
</div>
<div class="card-body">
...
<div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
  <a href="purchase_print.php?type=pos&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date;?>" class="btn btn-danger mb-2">Print report</a>
...
<?php
    ...
    $sno=1;
    while ($row=mysqli_fetch_assoc($purch_posquery)){
      # code...
      $id=$row['id'];
...
<a href="purchase_print.php?type=account_bill&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date;?>" class="btn btn-danger mb-2">Print report</a>
...
<?php
    ...
    $sno=1;
    while ($row=mysqli_fetch_assoc($purch_accountquery)){
        # code...
    $id=$row['id'];
