  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0">General Bill Details</h3>
...
<div class="row">
<div class="col-12">
<h4>General <small>Report</small></h4>
</div>
</div>
...
<li class="nav-item">
<a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Sales</a>
</li>
<li class="nav-item">
<a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Purchases</a>
</li>
</ul>
</div>
<div class="card-body">
...
<div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
  <a href="general_print.php?type=sales&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date;?>" class="btn btn-danger mb-2">Print report</a>
...
<a href="general_print.php?type=purchases&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date;?>" class="btn btn-danger mb-2">Print report</a>
